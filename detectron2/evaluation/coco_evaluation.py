...
def _evaluate_predictions_on_coco(
    ...
    coco_eval.summarize()
    # fp = np.array(coco_eval.eval['fp'])  # (10, 80, 101)
    # tp = np.array(coco_eval.eval['tp'])  # (10, 80, 101)

    # # 取 IoU=0.5 这一层
    # iou_idx = 0 
    # fp_iou_05 = fp[iou_idx]  # (80, 101)
    # tp_iou_05 = tp[iou_idx]  # (80, 101)

    # # 取最大召回率（最后一个 recall 点）的 FP 和 TP
    # fp_per_class = fp_iou_05[:, -1]  # (80,)
    # tp_per_class = tp_iou_05[:, -1]  # (80,)

    # # 打印每个类别的 FP 和 TP
    # for cls_idx, (fp_cls, tp_cls) in enumerate(zip(fp_per_class, tp_per_class)):
    #     print(f"Class {cls_idx}: FP = {fp_cls}, TP = {tp_cls}")
