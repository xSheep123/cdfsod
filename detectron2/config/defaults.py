...
_C.DATASETS.TRAIN = ()
_C.DATASETS.NUM_ANNOTATIONS = 0
_C.DATASETS.NUM_IMG = 0
...
# Loss Weight
# ---------------------------------------------------------------------------- #
_C.MODEL.GEO_WEIGHT = 100.0
_C.MODEL.CLASS_WEIGHT = 1.0
...
_C.DE.CLASS_INIT_PROTOTYPES = None
_C.DE.CLASS_GENERATE_PROTOTYPES = None
_C.DE.BG_PROTOTYPES = ""
_C.DE.TOPK = -1
